            ...
            <div class="auto-container">
                <div class="content-box">
                    ...
                    <div class="btn-box animate-3">
                        <a href="<?=$rows['btn_1_url'] ?>" class="theme-btn btn-style-one">
													<span class="btn-title"><?=$rows['btn_1_text'] ?></span>
												</a>
                        <a href="<?=$rows['btn_2_url'] ?>" class="theme-btn btn-style-one light">
													<span class="btn-title"><?=$rows['btn_2_text'] ?></span>
												</a>
                    </div>
                </div>
            </div>
