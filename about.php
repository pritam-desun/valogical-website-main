                ...
                <div class="row">
                        ...
                        <div class="inner-column">
                            ...
                            <div class="btn-box">
                                <?php if ($site_info_header['phone'] != '') { ?>
                                    <a href="tel:<?= $site_info_header['phone'] ?>" class="info-btn">
                    ...
                    <div class="image-column col-xl-6 col-lg-5 col-md-12 col-sm-12">
                        <div class="inner-column wow fadeInLeft">
                            ...
                            <figure class="image-2 overlay-anim wow fadeInRight"><img src="images/resource/about-2.jpg" alt="">
                            </figure>
                            ...
                            <div class="feature-block">
                                <div class="inner-box">
                                    <div class="content">
                                        ...
                                        <div class="text">Tincidunt elit magnis nulla facilisis sags maecenas. sapien nunc amet ultrices
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    document.title= "Taskenhancer :: About Us";
</script>