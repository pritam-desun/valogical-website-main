    ...
    <section class="page-title" style="background-image: url(images/main-slider/3.jpg);">
      <div class="auto-container">
        <div class="title-outer">
          <h1 class="title">Administrative Services</h1>
        ...
        <div class="row">
          ...
          <div class="col-xl-8 col-lg-8">
            <div class="services-details__content">
              <h3 class="mt-4">Administrative Services</h3>
              <p>Within this broad term of administrative assistance, we provide almost every admin service thinkable,
                some of which are – data entry, PowerPoint presentations, word processing, preparing spreadsheets, and
                transcription. Once you visit the services we are providing, you will be getting the best service ever.
              </p>
            </div>
            <div class="list">
              <ul>
