                    ...
                    <div class="p-5">
                      ...
                      <form class="user" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group ">
                          ...
                          <input type="text" class="form-control form-control-user" id="btn_1_text " name="btn_1_text" placeholder="btn_1_text ">
                        ...
                        <div class="form-group ">
                          ...
                          <input type="text" class="form-control form-control-user" id="btn_1_url " name="btn_1_url" placeholder="btn_1_url  ">
                          <?php if (isset($err['btn_1_url'])) { ?><div class="small alert-danger"><?= $err['btn_1_url']; ?></div> <?php } ?>
                        </div>
                        <div class="form-group ">
                          <label for="exampleFormControlTitle" class="form-label">Button_1_Text:</label>
                          <input type="text" class="form-control form-control-user" id="btn_2_text  " name="btn_2_text" placeholder="btn_2_text  ">
                        ...
                        <div class="form-group ">
                          ...
                          <input type="text" class="form-control form-control-user" id="btn_1_text " name="btn_2_url" placeholder="btn_1_url  ">
