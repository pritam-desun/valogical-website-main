...
require_once("inc/header.php"); 
    ...
    <section class="page-title" style="background-image: url(images/main-slider/3.jpg);">
      <div class="auto-container">
        <div class="title-outer">
          <h1 class="title">Email Organization</h1>
        ...
        <div class="row">
          ...
          <div class="col-xl-8 col-lg-8">
            <div class="services-details__content">
              <h3 class="mt-4">Email Organization</h3>
              <p>Quick and effective management of your email inbox so that each and every email is answered with
                promptness and no crucial business email is ever missed. Let us compose, filter and manage your email
                inbox for you so that you can have a de-cluttered experience with your email inboxes.</p>
            </div>
    ...
    <script>
    document.title= "Taskenhancer :: email-organization";
</script>